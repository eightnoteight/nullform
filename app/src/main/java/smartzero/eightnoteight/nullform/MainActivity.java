...
public class MainActivity extends AppCompatActivity {
    ...
    public static class FillFormFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_fillform, container, false);
            /*
            * fragment setup
            * */
            return rootView;
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return new FillFormFragment();
                case 1:
                    return new CreateFormFragment();
                case 2:
